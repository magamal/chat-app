...
import '../business/chat_history_mediator.dart' as _i8;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i7.BottomEditTextCubit>(
      () => _i7.BottomEditTextCubit(gh<_i4.ChatHistoryBusinessBroker>()));
  gh.singleton<_i8.CharHistoryMediator>(_i8.CharHistoryMediator(
    gh<_i5.DataBaseProcessor>(),
    gh<_i6.NetworkProcessor>(),
  ));
  gh.factory<_i9.ChatBodyContainerCubit>(
      () => _i9.ChatBodyContainerCubit(gh<_i4.ChatHistoryBusinessBroker>()));
  gh.factory<_i10.ImAppBarCubit>(
      () => _i10.ImAppBarCubit(gh<_i8.CharHistoryMediator>()));
  return getIt;
}
