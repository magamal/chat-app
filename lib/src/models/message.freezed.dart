...
abstract class $MessageCopyWith<$Res> {
  ...
  @useResult
  $Res call({String sender, String message});
}
...
class _$MessageImpl with DiagnosticableTreeMixin implements _Message {
  const _$MessageImpl({required this.sender, required this.message});
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, sender, message);
